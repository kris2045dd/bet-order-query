				...
				<div class="content">
					<form>
						...
						<div class="search_bet">
							...
							<input id="bet_dollar" type="text" placeholder="1" />

							<label for="bet_tail">注单尾数</label>
							<input id="bet_tail" type="text" placeholder="88888888" ng-model="body.tail_no" />
					...
					<div class="data_table style1">
						...
						<div class="d_list" ng-repeat="o in body.bet_orders |
							filter: {bet_order_id: body.tail_no} |
					...
					<nav class="text-center">
						<ul class="pagination"
							uib-pagination
							boundary-links="true"
							total-items="body.bet_orders.length"
							...
							first-text="&laquo;"
							last-text="&raquo;"
							ng-show="body.bet_orders.length"></ul>
					</nav>
		...
		$(function () {
			...
			app.controller("BodyCtrl", ["$scope", "$http", function ($scope, $http) {
				...
				this.applicable = function (bet_order) {
					console.log("applicable", bet_order);
					return true;
					return Math.round(Math.random()) ? true : false;
				};

				this.activityApplying = function (bet_order) {
					console.log("activityApplying", bet_order);
				}
			}]);
